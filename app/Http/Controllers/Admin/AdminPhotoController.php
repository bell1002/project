...
class AdminPhotoController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect('/admin/photo/view')->with('success', 'Photo is added successfully.');
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect('/admin/photo/view')->with('success', 'Photo is updated successfully.');
    ...
    public function delete($id){
        ...
        return redirect('/admin/photo/view')->with('success', 'Photo is deleted successfully.');
