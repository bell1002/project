...
class AdminTestimonialController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect('/admin/testimonial/view')->with('success', 'Testimonial is added successfully.');
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect('/admin/testimonial/view')->with('success', 'Testimonialis updated successfully.');
    ...
    public function delete($id){
        ...
        return redirect('/admin/testimonial/view')->with('success', 'Testimonial is deleted successfully.');
