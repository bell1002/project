...
class AdminVideoController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect('/admin/video/view')->with('success', 'Video is added successfully.');
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect('/admin/video/view')->with('success', 'Video is updated successfully.');
    ...
    public function delete($id){
        ...
        return redirect('/admin/video/view')->with('success', 'Video is deleted successfully.');
