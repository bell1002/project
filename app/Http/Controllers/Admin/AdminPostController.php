...
class AdminPostController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect('/admin/post/view')->with('success', 'Post is added successfully.');
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect('/admin/post/view')->with('success', 'Post is updated successfully.');
    ...
    public function delete($id){
        ...
        return redirect('/admin/post/view')->with('success', 'Post is deleted successfully.');
