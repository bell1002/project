...
class BookingController extends Controller
{
    ...
    // $predicted_price = $this->predict_price($room_id, $checkin_date, $checkout_date, $adults, $children);
    ...
    // session()->push('cart_predicted_price', $predicted_price);
    ...
    // function predictPrice($roomType, $numBeds, $numBathrooms, $balcony) {
    //     // Đường dẫn tới tệp mô hình XGBoost
    //     $modelPath = 'path/to/your/model.json';
    
    //     // Tải mô hình XGBoost
    //     $booster = new Booster();
    //     $booster->loadModel($modelPath);
    ...
    //     // Thực hiện dự đoán
    //     $predictedPrice = $booster->predict($data);
