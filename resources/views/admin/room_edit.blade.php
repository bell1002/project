...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin_room_update', $room_data) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" class="form-control h_100 snote" cols="30" rows="10">{{ $room_data->description }}</textarea>
                                </div>  
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="iframe-container1"> 
                                        <iframe width="300" height="315" src="https://www.youtube.com/embed/{{ $room_data->video_id }}" title="Youtube player" frameborder="0" allow="accelrometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picyure" allowfullscreen>
